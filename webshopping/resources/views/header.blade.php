<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> Nam Từ Liêm, Hà Nội</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 1800 86 86</a></li>
					</ul>
				</div>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="{{route('trang-chu')}}" id="logo"><img src="source/assets/dest/images/logo1.jpg" width="200px" alt=""></a>
				</div>
